...
public class A_Array {
	...
	public void method1() {
		...
		int[] score = new int[5]; // 배열의 크기를 지정하지 않으면 에러발생! 
...
//		System.out.println(score); //[I@3d012ddd
	 ...
	 * - 증감식을 사용하지 않고 배열 및 컬렉션의요소 개수만큼 반복하고 for문을 종료
	 * 
	 * */
...
;		 * */
	...
	public void method5() {
		...
		System.out.println(number.hashCode()); // hashCode : 객체를 식별할 하나의 정수
	...
	public void method8() {
		...
		// System.out.println(copy.length);  // NullpointException null 사용시 에러발생
